...
export function generateStellarPdf(data: StellarDemoResponse) {
  ...
  doc.setFontSize(6);
  doc.text(
    "This report was generated by Hera compliance infrastructure. All data in this demo is simulated.",
    ML, y,
  );
  doc.text(
    "For production compliance reports, contact your Hera workspace administrator.",
    ML, y + 4,
  );
